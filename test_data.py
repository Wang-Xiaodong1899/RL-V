...
# hf_data = hf_datasets.load_dataset("parquet", data_files='/root/autodl-tmp/RL-V/RLHF-V-Dataset/RLHF-V-Dataset.parquet')['train'].cast_column("image", hf_datasets.Image(decode=False))
...
data = hf_datasets.load_dataset("/root/autodl-tmp/RL-V/RLAIF-V-HIERAR-Dataset-6k")['train'].cast_column("image", hf_datasets.Image(decode=False))
