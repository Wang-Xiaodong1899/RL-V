...
def eval_model(args):
    ...
    model_path = "/home/user/wangxd/RL-V/RLAIF-V-7B"
    model_name='llava-v1.5-7b'
...
if __name__ == "__main__":
    ...
    parser.add_argument("--question-file", type=str, default="/home/user/wangxd/RL-V/eval/data/mmhal-bench_with_image.jsonl")
    parser.add_argument("--answers-file", type=str, default="/home/user/wangxd/RL-V/results/RLAIF-V-7B/mmhal-bench_answer.jsonl")
