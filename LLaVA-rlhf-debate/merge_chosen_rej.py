...
# 示例使用
merge_jsonl('/root/autodl-tmp/RL-V/LLaVA-rlhf-debate/llava_rlhf_for_leanpo-1w.jsonl', '/root/autodl-tmp/RL-V/LLaVA-rlhf-aug/llava_rlhf_aug-1w.jsonl', './llava_rlhf_merge-for_leanpo-1w.jsonl')
