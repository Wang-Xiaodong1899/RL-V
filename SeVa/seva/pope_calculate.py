...
if __name__ == "__main__":
    ...
    label_file_list = ['/mnt/storage/user/wangxiaodong/debug/LLaVA/playground/data/eval/pope/coco/coco_pope_adversarial.json',
                  '/mnt/storage/user/wangxiaodong/debug/LLaVA/playground/data/eval/pope/coco/coco_pope_adversarial.json',
                  '/mnt/storage/user/wangxiaodong/debug/LLaVA/playground/data/eval/pope/coco/coco_pope_adversarial.json']
    tag_list = ['random', 'popular', 'adversarial']
    for ans, label in zip(ans_file_list, label_file_list):
        eval_all(ans, label)
