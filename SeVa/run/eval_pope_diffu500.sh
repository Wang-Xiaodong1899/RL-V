MODEL_VERSION=$1
save_name=$2
model_base=$3 # /mnt/storage/user/wangxiaodong/RLAIF-V/llava-v1.5-7b

# MODEL_VERSION=/mnt/storage/user/wangxiaodong/RLAIF-V/seva-7b-diffu500
...
# convert
python /mnt/storage/user/wangxiaodong/RLAIF-V/convert_pope_answer.py --dirs ./seva/pope_result/${save_name}
...
python llava/eval/eval_pope.py \
    ...
    --result-file /mnt/storage/user/wangxiaodong/RLAIF-V/SeVa/seva/pope_result/${save_name}/pope_all.jsonl
