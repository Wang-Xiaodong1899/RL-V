MODEL_VERSION=$1
save_name=$2
model_base=$3 # /data2/wangxd/models/llava-v1.5-7b

# MODEL_VERSION=/home/user/wangxd/RL-V/seva-7b-diffu500
...
# convert
python /home/user/wangxd/RL-V/convert_pope_answer.py --dirs ./seva/pope_result/${save_name}
...
python llava/eval/eval_pope.py \
    ...
    --result-file /home/user/wangxd/RL-V/SeVa/seva/pope_result/${save_name}/pope_all.jsonl
