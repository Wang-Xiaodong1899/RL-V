...
exp_name=FT_pbs1_V8_Entail-fine-filter_${lr}_ZERO3_run1
...
deepspeed /home/user/wangxd/RL-V/muffin/train/train_llava15.py \
    --deepspeed /home/user/wangxd/RL-V/script/zero3.json  \
