...
OCR_DPO_DATA=/workspace/wxd/RL-V/seva_data/ocrvqa_dpo_8k_diffusion_step500.json
TEXT_DPO_DATA=/workspace/wxd/RL-V/seva_data/textvqa_dpo_8k_filter_diffusion_step500.json
...
deepspeed muffin/train/train_dpo_lora.py \
    ...
    --ocr_image_path /workspace/wxd/RL-V/ocr-qa/ocr_vqa/images/ \
    --textvqa_data_path ${TEXT_DPO_DATA} \
    --textvqa_image_path /workspace/wxd/RL-V/playground/data/eval/textvqa/train_images/ \
