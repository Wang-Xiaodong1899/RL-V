...
def parse_args():
    ...
    parser.add_argument("--video_path", help="Path to the video files.", default="xU25MMA2N4aVtYay.mp4")
    parser.add_argument("--output_dir", help="Directory to save the model results JSON.", default="output_dir")
    parser.add_argument("--output_name", help="Name of the file for storing results JSON.", default="xU25MMA2N4aVtYay.mp4")
