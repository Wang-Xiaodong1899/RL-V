...
def arg_parser(prompt=prompt):
    ...
    parser.add_argument(
        "--mmvet_path",
        type=str,
        default="/mnt/storage/user/wangxiaodong/RLAIF-V/playground/data/eval/mm-vet",
        help="Download mm-vet.zip and `unzip mm-vet.zip` and change the path here",
    )
    parser.add_argument(
        "--result_file",
        type=str,
        default="/mnt/storage/user/wangxiaodong/RLAIF-V/playground/data/eval/mm-vet/results/llava-v1.5-7b.json",
    ...
    parser.add_argument(
        "--openai_api_key", type=str, default='sk-UYqwq36Z0hmfyaWJ69F675A344D645D79c9dB863Ae870eAd',
